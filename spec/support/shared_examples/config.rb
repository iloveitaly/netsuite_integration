shared_examples "config hash" do
  let(:config) do
    { 'netsuite.api_version' => '2013_2',
      'netsuite.wsql_url' => 'https://webservices.na1.netsuite.com/wsdl/v2013_2_0/netsuite.wsdl',
...
shared_context "request parameters" do
  let(:parameters) do
    [
      ...
      {:name => 'netsuite.wsql_url', :value => "https://webservices.na1.netsuite.com/wsdl/v2013_2_0/netsuite.wsdl" },
