config_hash = {
  ...
  'netsuite_last_updated_after' => '2012-01-08T18:48:56.001Z',
  ...
  let(:parameters) do
    {
      ...
      "netsuite_password" => "test",
      "netsuite_account" => "test",
      "netsuite_last_updated_after" => "2013-01-08T18:48:56.001Z",
      "netsuite_account_for_sales_id" => "2",
      "netsuite_shipping_methods_mapping" => [{ "UPS" => "77", "UPS Ground (USD)"=>"92", "UPS Two Day (USD)"=>"91", "UPS One Day (USD)"=>"77" }],
      "netsuite_payment_methods_mapping" => [{ "Credit Card" => "5", "Cash" => "1" }]
    }
  end
end
